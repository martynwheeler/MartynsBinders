...
class NuclearData:
    ...
    def printTableSI(self, nucleus):
        ...
        print('{:<36s}{:<14d}'.format('Nucleon Number', self.getNucleonNumber(nucleus)))
        print('{:<36s}{:<14d}'.format('Neutron Number', self.getNeutronNumber(nucleus)))
        print('{:<36s}{:<16.10e}'.format('Atomic Mass / kg', self.getAtomicMassKG(nucleus)))
        print('{:<36s}{:<16.10e}'.format('Nuclear Mass / kg', self.getNuclearMassKG(nucleus)))
        print('{:<36s}{:<16.10e}'.format('Mass Defect / kg', self.getMassDefectKG(nucleus)))
        print('{:<36s}{:<16.10e}'.format('Binding Energy / J', self.getBindingEnergyJ(nucleus)))
        print('{:<36s}{:<16.10e}'.format('Binding Energy per Nucleon / J', self.getBindingEnergyPerNucleonJ(nucleus)))
        print(dash)
